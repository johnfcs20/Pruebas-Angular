...
describe('Medicos Component', () => {
  ...
  xit('Si falla la adicion ,la propiedad mensajeError, debe ser igual al error del servicio', () => {
  ...
  it('Debe de llamar al servidor paa borrar un medico', () => {
  ...
  it('No Debe de llamar al servidor paa borrar un medico', () => {
